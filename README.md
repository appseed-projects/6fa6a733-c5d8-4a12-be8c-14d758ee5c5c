...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-14 08:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6fa6a733-c5d8-4a12-be8c-14d758ee5c5c.git
$ cd 6fa6a733-c5d8-4a12-be8c-14d758ee5c5c
```
